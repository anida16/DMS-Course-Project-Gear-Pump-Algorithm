...
optList = ['CCI_Grade_20', 'CI_Grade_25', 'CI_Grade_35',
            'CI_Grade_35_Heated', 'Steel_C45',
            'Steel_15Ni', 'Steel_40Ni']
...
def mainProgram():
    ...
    assumptionsWindow.grid(column=0, row=0, sticky=(N))    # PLEASE CORRECT THIS
    ...
    resultWindow.grid(column=0, row=0, sticky=(N))
